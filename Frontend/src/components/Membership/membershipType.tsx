      ...
      <Box paddingBottom={4}>
        <FormControl>
          ...
          >
            ...
            <div className="card w-500 h-100" style={{ marginBottom: "30px" }}>
              <div className="card-body" style={{ display: "flex" }}>
                <div style={{ flex: 1 }}>
                  <Image
                    src={require("./NAFA_Logo.PNG")}
            ...
            <div className="card w-500 h-100" style={{ marginBottom: "30px" }}>
              <div className="card-body" style={{ display: "flex" }}>
                ...
                <div style={{ flex: 2, paddingRight: "100px" }}>
                  ...
                  <p className="card-text">
                    This is the membership for new graduates and whoevers is
                    below 25 yrs. <br />
            ...
            <div className="card w-500 h-100" style={{ marginBottom: "30px" }}>
              <div className="card-body" style={{ display: "flex" }}>
                ...
                <div style={{ flex: 2, paddingRight: "100px" }}>
                  ...
                  <p className="card-text">
                    This is special membership for single or couple with special
                    features. <br />
