...
import PayEvent from "./Payment/PayEvent";
import { donateEvent } from "../../services/api";
      ...
      >
        {userRole != null ? (
            ...
            <Modal.Footer style={{ paddingTop: "0px", marginTop: "0px" }}>
              ...
              <div>
                ...
                <PayEvent
                  ...
                  amount={eventDetail[id].entranceFee}
                />{" "}
              </div>
            </Modal.Footer>
          </Modal>
          ...
          <Modal show={show} onHide={() => setShow(false)}>
            ...
            <Modal.Body style={{ paddingBottom: "0px" }}>
              Please login to attend the event
            </Modal.Body>
            <Modal.Footer style={{ paddingTop: "0px", marginTop: "0px" }}>
              <Button
                variant="secondary"
