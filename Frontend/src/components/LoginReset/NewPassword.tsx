      ...
      <form className="card mt-4">
        <div className="card-body">
          <div className="form-group">
            ...
            <input className="form-control" type="password" id="email-for-pass" onChange={(e) => setUsers({ ...users, password: e.target.value })}/>
            <label className="email-for-pass">Re-type password </label>
            <input className="form-control" type="password" id="email-for-pass" />
          </div>
        </div>
