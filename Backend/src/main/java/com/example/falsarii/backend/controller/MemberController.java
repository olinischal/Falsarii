...
//			return ResponseEntity.badRequest().body(new MessageResponse("Error: Assure that you are human!"));
		}
...
//			return ResponseEntity.badRequest().body(new MessageResponse("Error: Email is already taken!"));
		...
		Member member = new Member(signUpRequest.getFirstName(), signUpRequest.getMaidenName(),
				signUpRequest.getLastName(),

				signUpRequest.getPhoneNumber(), signUpRequest.getEmail(),

				encoder.encode(signUpRequest.getPassword()), signUpRequest.getGraduationDate());
	...
	private boolean verifyReCAPTCHA(String gRecaptchaResponse) {
		...
		ReCaptchaResponse response = restTemplate.postForObject("https://www.google.com/recaptcha/api/siteverify", map,
